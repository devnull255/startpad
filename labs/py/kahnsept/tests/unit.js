...
global_namespace.Define('startpad.jsunit', function(UT) {
	var Timer = UT.Import('startpad.timer');
	var Base = UT.Import('startpad.base');
...
DWOutputDiv: function()
    {
    document.write("<DIV style=\"font-family: Courier;border:1px solid red;\" id=\"divUnit\">Unit Test Output</DIV>");
    },
